import { IBlog, ICategory, ISubCategory } from './Blog.d';
import { IRequest, INext, IResponse, IPayload, IGetQuery, TypedRequestQuery, IEditQuery } from './Global.d';
...
export {
    ...
    , IBlog, ICategory, ISubCategory, IEditQuery
};